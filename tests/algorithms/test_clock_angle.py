...
class ClockAngleTestCase(unittest.TestCase):
    def setUp(self):
        self.teste_instance_0 = ClockAngle([12, 0])
        self.teste_instance_1 = ClockAngle([15, 30])
        self.teste_instance_2 = ClockAngle([15, 45, 30])
        self.teste_instance_3 = ClockAngle([12, 45])
        self.teste_instance_4 = ClockAngle([17, 37])
        self.teste_instance_5 = ClockAngle([12, 45, 0])
        self.teste_instance_6 = ClockAngle([5, 37])
